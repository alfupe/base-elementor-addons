<?php
/**
 * Plugin Name: Base Elementor Addons
 * Description: A collection of widgets for Elementor.
 * Plugin URI:  https://yabbadabba.dev/
 * Version:     1.0.0
 * Author:      YabbaDabbaDev
 * Author URI:  https://yabbadabba.dev/
 * Text Domain: yabbadabbadev
 */
...
class BaseElementorAddons {
    const NAME = 'base-elementor-addons';
    const VERSION = '1.0.0';
    ...
    public function init() {
        ...
        require_once('GutenbergBlocks/GutenbergBlocks.php');
    }
